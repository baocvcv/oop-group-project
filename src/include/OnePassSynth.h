...
public:
    ...
    std::vector<std::vector<std::vector<std::pair<int, int>>>> get_grid() { return solver_.get_grid(); }
    ...
    //   std::string label_;
    //}
    std::vector<int> get_sink_dispenser_pos() { return solver_.get_sink_dispenser_pos(); }
